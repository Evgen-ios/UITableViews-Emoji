...
//  DataManager
//
//  Created by Evgeniy Goncharov on 13.09.2021.
//
...
class DataManager {
    var archiveURL: URL? {
        guard let documentDirctory = FileManager.default.urls(for: .documentDirectory, in:.userDomainMask ).first else { return nil }
